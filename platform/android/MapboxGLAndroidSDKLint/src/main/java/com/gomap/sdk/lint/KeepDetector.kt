...
class KeepDetector : Detector(), SourceCodeScanner, FileScanner {
    companion object {
        private val DETECTOR_CLASS = _root_ide_package_.com.gomap.sdk.lint.KeepDetector::class.java
        private val DETECTOR_SCOPE = Scope.JAVA_FILE_SCOPE
        private val IMPLEMENTATION = Implementation(_root_ide_package_.com.gomap.sdk.lint.KeepDetector.Companion.DETECTOR_CLASS, _root_ide_package_.com.gomap.sdk.lint.KeepDetector.Companion.DETECTOR_SCOPE)
        ...
        var ISSUE_NOT_KEPT = Issue.create(
                _root_ide_package_.com.gomap.sdk.lint.KeepDetector.Companion.ISSUE_ID,
                _root_ide_package_.com.gomap.sdk.lint.KeepDetector.Companion.ISSUE_DESCRIPTION,
                _root_ide_package_.com.gomap.sdk.lint.KeepDetector.Companion.ISSUE_EXPLANATION,
                _root_ide_package_.com.gomap.sdk.lint.KeepDetector.Companion.ISSUE_CATEGORY,
                _root_ide_package_.com.gomap.sdk.lint.KeepDetector.Companion.ISSUE_PRIORITY,
                _root_ide_package_.com.gomap.sdk.lint.KeepDetector.Companion.ISSUE_SEVERITY,
                _root_ide_package_.com.gomap.sdk.lint.KeepDetector.Companion.IMPLEMENTATION
        )
    }
    ...
    override fun createUastHandler(context: JavaContext): UElementHandler? = _root_ide_package_.com.gomap.sdk.lint.KeepDetector.KeepHandler(context)
    ...
    class KeepHandler(private val context: JavaContext) : UElementHandler() {
        ...
        override fun visitMethod(node: UMethod) {
            if (node.hasModifier(JvmModifier.NATIVE) && checkKeepAnnotation(node)) {
                context.report(
                        _root_ide_package_.com.gomap.sdk.lint.KeepDetector.Companion.ISSUE_NOT_KEPT,
                    node,
