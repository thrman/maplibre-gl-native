...
import com.gomap.sdk.location.engine.LocationEngine;
...
import com.gomap.sdk.maps.MapboxMap.OnCameraIdleListener;
import com.gomap.sdk.maps.MapboxMap.OnCameraMoveListener;
import com.gomap.sdk.maps.MapboxMap.OnMapClickListener;
...
import static com.gomap.sdk.location.LocationComponentConstants.DEFAULT_FASTEST_INTERVAL_MILLIS;
import static com.gomap.sdk.location.LocationComponentConstants.DEFAULT_INTERVAL_MILLIS;
import static com.gomap.sdk.location.LocationComponentConstants.DEFAULT_TRACKING_TILT_ANIM_DURATION;
import static com.gomap.sdk.location.LocationComponentConstants.DEFAULT_TRACKING_ZOOM_ANIM_DURATION;
 ...
 * to the {@link com.gomap.sdk.location.engine.MapboxFusedLocationEngineImpl}. If you'd like to utilize Google
 * Play Services
 * for more precise location updates, simply add the Google Play Location Services dependency in your build script.
 * This will make the default engine the {@link com.gomap.sdk.location.engine.GoogleLocationEngineImpl} instead.
...
public final class LocationComponent {
  ...
  public void setRenderMode(@RenderMode.Mode int renderMode) {
    checkActivationState();
    if (lastLocation != null && renderMode == RenderMode.GPS) {
   ...
   * {@link MapboxMap.OnMapClickListener#onMapClick(LatLng)} is going to be consumed
   ...
   * {@link MapboxMap.OnMapLongClickListener#onMapLongClick(LatLng)} is going to be consumed
   * and not pushed to the listeners registered after the component's activation.
   *
   * @param listener The location click listener that is invoked when the
   *                 location is clicked
