...
public:
    ...
    static constexpr auto Name() { return "com/gomap/sdk/storage/FileSource"; };

    struct ResourceTransformCallback {
        static constexpr auto Name() { return "com/gomap/sdk/storage/FileSource$ResourceTransformCallback"; }
    ...
    struct ResourcesCachePathChangeCallback {
        static constexpr auto Name() { return "com/gomap/sdk/storage/FileSource$ResourcesCachePathChangeCallback";}
