...
public:
    ...
    public:
        static constexpr auto Name() { return "com/gomap/sdk/offline/OfflineRegion$OfflineRegionObserver"; };
    };

    class OfflineRegionStatusCallback {
    public:
        static constexpr auto Name() { return "com/gomap/sdk/offline/OfflineRegion$OfflineRegionStatusCallback"; };
    ...
    public:
        static constexpr auto Name() { return "com/gomap/sdk/offline/OfflineRegion$OfflineRegionDeleteCallback"; };
    ...
    public:
        static constexpr auto Name() { return "com/gomap/sdk/offline/OfflineRegion$OfflineRegionInvalidateCallback"; };
    ...
    public:
        static constexpr auto Name() { return "com/gomap/sdk/offline/OfflineRegion$OfflineRegionUpdateMetadataCallback"; };
    ...
    static constexpr auto Name() { return "com/gomap/sdk/offline/OfflineRegion"; };
