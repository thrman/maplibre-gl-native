...
public:
    static constexpr auto Name() { return "com/gomap/sdk/offline/OfflineRegionDefinition"; };
...
public:
    ...
    static constexpr auto Name() { return "com/gomap/sdk/offline/OfflineTilePyramidRegionDefinition"; };
...
public:
    using SuperTag = OfflineRegionDefinition;
    static constexpr auto Name() { return "com/gomap/sdk/offline/OfflineGeometryRegionDefinition"; };
