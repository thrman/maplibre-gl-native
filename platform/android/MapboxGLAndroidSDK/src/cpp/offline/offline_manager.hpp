...
public:
    ...
    public:
        static constexpr auto Name() { return "com/gomap/sdk/offline/OfflineManager$ListOfflineRegionsCallback";}
    ...
    public:
        static constexpr auto Name() { return "com/gomap/sdk/offline/OfflineManager$CreateOfflineRegionCallback"; }
    ...
    public:
        static constexpr auto Name() { return "com/gomap/sdk/offline/OfflineManager$MergeOfflineRegionsCallback";}
    ...
    struct FileSourceCallback {
        static constexpr auto Name() { return "com/gomap/sdk/offline/OfflineManager$FileSourceCallback";}
    ...
    static constexpr auto Name() { return "com/gomap/sdk/offline/OfflineManager"; };
