...
import com.gomap.sdk.maps.renderer.MapRenderer;
import com.gomap.sdk.maps.renderer.glsurfaceview.GLSurfaceViewMapRenderer;
import com.gomap.sdk.maps.renderer.glsurfaceview.MapboxGLSurfaceView;
import com.gomap.sdk.maps.renderer.textureview.TextureViewMapRenderer;
...
import com.gomap.sdk.net.ConnectivityReceiver;
...
public class MapView extends FrameLayout implements NativeMapView.ViewCallback {
    ...
    return new OnClickListener() {
      ...
      public void onClick(View v) {
        if (mapboxMap != null && compassView != null) {
          if (focalPoint != null) {
            mapboxMap.setFocalBearing(0, focalPoint.x, focalPoint.y, CompassView.TIME_MAP_NORTH_ANIMATION);
          } else {
            mapboxMap.setFocalBearing(0, mapboxMap.getWidth() / 2, mapboxMap.getHeight() / 2, CompassView.TIME_MAP_NORTH_ANIMATION);
          }
          ...
          compassView.postDelayed(compassView, CompassView.TIME_WAIT_IDLE + CompassView.TIME_MAP_NORTH_ANIMATION);
        }
      }
    };
  }
  ...
  /**
   * Sets the strict mode that will throw the {@link com.gomap.sdk.MapStrictModeException}
