package com.gomap.sdk.geometry;
...
import com.gomap.sdk.exceptions.InvalidLatLngBoundsException;
...
public class LatLngBounds implements Parcelable {
  ...
  public static LatLngBounds world() {
    return LatLngBounds.from(
            GeometryConstants.MAX_LATITUDE, GeometryConstants.MAX_WRAP_LONGITUDE,
            GeometryConstants.MIN_LATITUDE, GeometryConstants.MIN_WRAP_LONGITUDE);
  }
