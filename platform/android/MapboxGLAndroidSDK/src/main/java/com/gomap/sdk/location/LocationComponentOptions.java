...
public class LocationComponentOptions implements Parcelable {
   ...
   * the first parameter of {@link Style.Builder#addImage(String, Bitmap)}, the
   ...
   * and the custom {@link AndroidGesturesManager} that was set with
   * {@link MapboxMap#setGesturesManager(AndroidGesturesManager, boolean, boolean)}.
   *
   ...
   * <p>
   * Best paired with the {@link Builder#trackingMultiFingerMoveThreshold(float)}
   ...
   * {@link Style#addLayerAbove(Layer, String)}.
   * <p>
  ...
  /**
   * Gets the id of the layer that's referenced when placing the component on the map using
   * {@link Style#addLayerBelow(Layer, String)}.
   * <p>
  ...
  /**
   * Enable or disable smooth animation of compass values for {@link CameraMode}
   * and {@link RenderMode}.
   *
  ...
  public static class Builder {
     ...
     */
    @NonNull
    public Builder trackingMultiFingerProtectedMoveArea(@Nullable RectF rect) {
     ...
     * @return whether the LocationComponent's pulsing circle is enabled
     */
    public Builder pulseEnabled(boolean pulseEnabled) {
      this.pulseEnabled = pulseEnabled;
      return this;
    }
     ...
     * @return whether fading of the LocationComponent's pulsing circle is enabled
     */
    public Builder pulseFadeEnabled(boolean pulseFadeEnabled) {
      this.pulseFadeEnabled = pulseFadeEnabled;
      return this;
    }
     ...
     * @return the current set color of the circle
     */
    public Builder pulseColor(@ColorInt int pulseColor) {
      this.pulseColor = pulseColor;
      return this;
    }
     ...
     * @return the current set length of time for a single pulse
     */
    public Builder pulseSingleDuration(float pulseSingleDuration) {
      this.pulseSingleDuration = pulseSingleDuration;
      return this;
    }
     ...
     * @return the maximum radius that the pulsing circle will expand to.
     */
    public Builder pulseMaxRadius(float pulseMaxRadius) {
      this.pulseMaxRadius = pulseMaxRadius;
      return this;
    }
     ...
     * @return the current opacity of the LocationComponent's pulsing circle
     */
    public Builder pulseAlpha(float pulseAlpha) {
      this.pulseAlpha = pulseAlpha;
      return this;
    }
     ...
     */
    public Builder pulseInterpolator(Interpolator pulseInterpolator) {
      this.pulseInterpolator = pulseInterpolator;
      return this;
    }
