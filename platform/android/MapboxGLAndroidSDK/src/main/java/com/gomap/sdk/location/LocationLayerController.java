...
final class LocationLayerController {
  ...
  private void determineIconsSource(LocationComponentOptions options) {
    String foregroundIconString = buildIconString(
      renderMode == RenderMode.GPS ? options.gpsName() : options.foregroundName(), LocationComponentConstants.FOREGROUND_ICON);
    String foregroundStaleIconString = buildIconString(options.foregroundStaleName(), LocationComponentConstants.FOREGROUND_STALE_ICON);
    String backgroundIconString = buildIconString(options.backgroundName(), LocationComponentConstants.BACKGROUND_ICON);
    String backgroundStaleIconString = buildIconString(options.backgroundStaleName(), LocationComponentConstants.BACKGROUND_STALE_ICON);
    String bearingIconString = buildIconString(options.bearingName(), LocationComponentConstants.BEARING_ICON);
